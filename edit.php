                ...
                <form action="editPost.php" method="post" enctype="multipart/form-data">
                    <table class="table">
                        <tr>
							...
							<td>
								<div class="form-group">
									<textarea class="form-control" id="exampleFormControlTextarea1" name="title" placeholder="Enter title here" rows="1"><?php echo $result['Title'];?></textarea>
								</div>
							</td>
						...
						<tr>
							<td>
								...
								<div class="form-group">
									<textarea class="form-control" id="exampleFormControlTextarea1" name="posting" rows="25"><?php echo $result['Publish'];?></textarea>
